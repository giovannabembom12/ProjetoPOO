...
public class InscrevarSe extends javax.swing.JFrame {
    public InscrevarSe() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextField2.setFont(new java.awt.Font("Segoe UI", 0, 16)); 
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(InscrevarSe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InscrevarSe().setVisible(true);
            }
        });
    }
